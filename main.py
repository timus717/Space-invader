...
for index in range(0, no_bullet):
    ...
    random_bullety = random.randint(100, 200)
...
def help_text():
    while True:
        ...
        description_help1 = text_description_aboutgame.render(" suggestion for enhancement of game you can ", True,
                                                              (255, 255, 255))
        description_help2 = text_description_aboutgame.render("simply mail on  \"timusvishwakarma@gmail.com\". ", True,
                                                              (255, 255, 255))
...
def about_text():
    ...
    while True:
        ...
        description_developer = text_description_aboutgame.render("This game is designed and written by", True,
                                                                  (255, 255, 255))
        description_developer1 = text_description_aboutgame.render("Sumit Vishwakarma", True, (255, 255, 255))
